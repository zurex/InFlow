...
import { Avatar, AvatarFallback, AvatarImage } from 'inflow/components/ui/avatar'
import { Card, CardContent } from 'inflow/components/ui/card'
import { SerperSearchResultItem } from 'inflow/lib/types'
