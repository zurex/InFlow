...
import { AvatarImage, Avatar, AvatarFallback } from 'inflow/components/ui/avatar'
import { CardContent, Card } from 'inflow/components/ui/card';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger
} from 'inflow/components/ui/dialog';
import {
  Carousel,
  type CarouselApi,
  CarouselContent,
  ...
  CarouselNext,
  CarouselPrevious
} from 'inflow/components/ui/carousel';
import { SerperSearchResultItem, SerperSearchResults } from 'inflow/lib/types';
