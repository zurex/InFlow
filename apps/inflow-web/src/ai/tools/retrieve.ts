import { DeepPartial, InferUITool, tool } from 'ai';
import { z } from 'zod';
import { SearchResults as SearchResultsType } from 'inflow/ai/tools/search';
...
export type RetrieveTool = InferUITool<typeof retrieveTool>;